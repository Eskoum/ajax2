...
public final class machineForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        var result = confirm(\"Voulez vous supprimé cette machine ?\");\n");
      out.write("        if (result) {\n");
      ...
      out.write("\n");
      out.write("<script>\n");
      out.write("    function showConfirmation1(etudiantId) {\n");
      out.write("        var result = confirm(\"Voulez vous supprimé cet etudiant ?\");\n");
      out.write("        if (result) {\n");
      out.write("            // L'utilisateur a cliqué sur \"OK\", redirigez vers la servlet pour effectuer la suppression.\n");
      ...
      out.write("\n");
      out.write("<script>\n");
      out.write("    function showConfirmation2(marqueId) {\n");
      out.write("        var result = confirm(\"Voulez vous supprimé cette marque ?\");\n");
      out.write("        if (result) {\n");
      out.write("            // L'utilisateur a cliqué sur \"OK\", redirigez vers la servlet pour effectuer la suppression.\n");
      out.write("            window.location.href = \"MachineController?op=delete&id=\" + marqueId;\n");
      out.write("        } else {\n");
      out.write("            // L'utilisateur a cliqué sur \"Annuler\", ne rien faire.\n");
      out.write("        }\n");
      out.write("    }\n");
